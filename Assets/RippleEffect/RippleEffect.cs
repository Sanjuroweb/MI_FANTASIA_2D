...
public class RippleEffect : MonoBehaviour
{
    ...
    class Droplet
    {
        ...
        public void Reset(Vector2 posicion) //pasamos un param vector2 en concreto 15
        {
            //estos valores aleatorios son los que luego se ven en toda la escena goteando 15
            //position = new Vector2(Random.value, Random.value);

            //queremos que sea un vector concreto 15
            position = posicion;
            time = 0;
        }
        ...
        public void Update()
        {
            //lo multiplicamos por 2 pa ir mas rapido en la onda expansiva 24
    ...
    void Update()
    {
        if (dropInterval > 0)
        {
            ...
            {
                //Emit(); //este ciclo emite las ondas, solo queremos que se emita una vez por eso lo comenbtamos 15
                timer -= dropInterval;
            }
        }
    ...
    public void Emit(Vector2 posicion) //15
    {
        droplets[dropCount++ % droplets.Length].Reset(posicion); //15
    }
}
