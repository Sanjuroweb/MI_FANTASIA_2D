...
public class EscupitajoPared : MonoBehaviour
{
    //VIENE DE BOLA MAGO
    ...
    public Vector2 direccionEscupitajo;
    ...
    {
        //me
        // Aplicar la dirección inicial al Rigidbody
        //rb.AddForce(direccionEscupitajo, ForceMode2D.Impulse);
    }
    ...
    void Update()
    {
        ...
        float angulo = Mathf.Atan2(direccionEscupitajo.y, direccionEscupitajo.x) * Mathf.Rad2Deg;
